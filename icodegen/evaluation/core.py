...
__all__ = ['get_mean_probs', 'find_parens', 'mean_dist_probs', 'token_taxonomy', 'get_error_rates', 'ERROR_THRESHOLD',
           'get_error_rates_df', 'ERROR_THRESHOLD', 'get_mean_cross_entropy', 'get_mean_probs',
           'get_mean_cross_entropy_df', 'evaluate']
...
def evaluate(data_path, model_path, experiment_path):
    ...
    for m_path in model_path.glob("*/"):
        model = None
        if "rnn_" in m_path.name:
            continue
        elif "gru_layers1_vocab10000_embed256_units2048" in m_path.name:
            continue
        print(m_path)
