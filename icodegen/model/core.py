...
__all__ = ['logger', 'Model', 'TransformerModel', 'RNNModel', 'VANILLA_CONFIG', 'GRU_CONFIG_1', 'GRU_CONFIG_2',
           'GRU_CONFIG_3', 'GRU_CONFIG_4', 'GRU_CONFIG_5', 'train']
...
class TransformerModel(Model):
    ...
    def generate(self, n, max_legnth, top_k=10, temperature=1.0):
        """

        """

        input_seed = self.tokenizer.encode("<sos>", return_tensors='tf')
    ...
    def train(self, ds_train, ds_val, epochs):
        ...
        history = model.fit(ds_train, epochs=epochs, callbacks=self.callbacks, validation_data=ds_val)
        return history
